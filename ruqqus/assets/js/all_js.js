...
//GIFS
	...
	function loadEmojis() {
		...
		for (i = 0; i < emojis.length; i++) { 
			str += `<button class="btn my-2 px-0 py-2" onclick="getEmoji(\'${emojis[i]}\')" style="overflow: hidden;" data-toggle="tooltip" title=":${emojis[i]}:" delay:="0"><img width=25 src="/assets/images/emojis/${emojis[i]}.gif" alt="${emojis[i]}-emoji"/></button>`;
		}
