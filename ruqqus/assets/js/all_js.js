...
function switch_css() {
  ...
  if (css.href.includes("https://rdrama.net/assets/style/main.css")) {
    post("/settings/dark_mode/1",
      callback=function(){
        css.href="https://rdrama.net/assets/style/main_dark.css?v=2.35.94";
    ...
    post("/settings/dark_mode/0",
      callback=function(){
        css.href="https://rdrama.net/assets/style/main.css?v=2.35.94";
