...
<<<<<<< HEAD
		if os.path.isfile(f'/d/ruqqus/assets/images/emojis/{i.group(1)}.gif'): sanitized = sanitized.replace(f':{i.group(1)}:', f'<img height=20 src="/assets/images/emojis/{i.group(1)}.gif"')
=======
		if os.path.isfile(f'/d/ruqqus/assets/images/emojis/{i.group(1)}.gif'): sanitized = sanitized.replace(f':{i.group(1)}:', f'<img height=20 src="/assets/images/emojis/{i.group(1)}.gif">')
>>>>>>> 572045556b0b31182fb10d2ddb5f9c704d78ff95
