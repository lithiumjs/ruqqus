...
3	Code Contributor	Contributed to Drama source code	git.png	3	3	\N
4	White Hat	Responsibly reported a security issue	whitehat.png	3	3	\N
7	Sitebreaker	Inadvertantly broke Drama	sitebreaker.png	3	2	\N
8	Unsilenced	Drama rejected a foreign order to take down this user's content.	unsilenced.png	3	4	\N
1	Alpha User	Joined Drama during open alpha	alpha.png	4	4	\N
6	Beta User	Joined Drama during open beta	beta.png	4	3	\N
9	Unknown	Drama rejected a foreign order to turn over this user's information	unknowable.png	3	4	\N
2	Verified Email	Verified Email	mail.png	1	1	v.is_activated
13	New User	Been on Drama for less than 30 days	baby.png	1	1	v.age < 2592000
15	Idea Maker	Had a good idea for Drama which was implemented by the developers	idea.png	3	2	\N
16	Game Night Participant	Participated in a Drama community gaming event	game-participant.png	3	2	\N
17	Game Night Finalist	Had a top finish in a Drama community gaming event	game-highfinish.png	3	3	\N
18	Artisan	Contributed to Drama artwork or text	art.png	3	3	\N
20	Dumpster Arsonist	Awarded to 8535 tenacious users who managed to sign up for Drama while the servers were getting crushed	dumpsterfire.png	5	6	\N
...
58	Diamond Recruiter	Recruited 1000 friends to join Drama	recruit-1000.png	1	4	v.referral_count >= 1000
10	Bronze Recruiter	Recruited 1 friend to join Drama	recruit-1.png	1	1	v.referral_count>=1 and v.referral_count<9
11	Silver Recruiter	Recruited 10 friends to join Drama	recruit-10.png	1	2	v.referral_count>=10 and v.referral_count <= 99
12	Gold Recruiter	Recruited 100 friends to join Drama	recruit-100.png	1	3	v.referral_count>=100 and v.referral_count <=999
14	Charter Supporter	Financially supported Drama during start-up	charter.png	4	4	\N
59	One Year	On Drama for one year	year-1.png	1	5	v.age_string=="1 year ago"
\.
...
1	FF66AC	t	Arts		fa-palette	f
2	FF66AC	t	Business		fa-chart-line	f
3	FF66AC	t	Culture		fa-users	f
4	FF66AC	t	Discussion		fa-podium	f
5	FF66AC	t	Entertainment		fa-theater-masks	f
6	FF66AC	t	Gaming		fa-alien-monster	f
8	FF66AC	t	Health		fa-heart	f
9	FF66AC	t	Lifestyle		fa-tshirt	f
10	FF66AC	t	Memes		fa-grin	f
11	FF66AC	t	News		fa-newspaper	f
13	FF66AC	t	Science		fa-flask	f
14	FF66AC	t	Sports		fa-baseball-ball	f
15	FF66AC	t	Technology		fa-microchip	f
7	FF66AC	t	Hobbies		fa-wrench	f
12	FF66AC	t	Politics		fa-university	f
\.
...
27	f	, the Innovative	v.has_badge(15)	Had a good idea for Drama	603abb	1	\N	\N	0	\N	\N
...
8	f	, the Invited	v.referred_by	Joined Drama from another user's referral	55aa55	4	\N	\N	0	\N	\N
28	f	 the Gamer	v.has_badge(16)	Participate in Drama gaming night	bb00bb	1	\N	\N	0	\N	\N
29	f	 [Level 1337]	v.has_badge(17)	Earn a top finish in a Drama gaming night	aaaa66	1	\N	\N	0	\N	\N
4	f	, Breaker of Drama	v.has_badge(7)	Inadvertently break Drama	dd5555	3	\N	\N	0	\N	\N
17	f	, the Unsilenced	v.has_badge(8)	We rejected a foreign order to take down your content	666666	3	\N	\N	0	\N	\N
5	f	 the Codesmith	v.has_badge(3)	Make a contribution to the Drama codebase	5555dd	3	\N	\N	0	\N	\N
...
26	f	 the Generous	v.has_badge(14)	Financially supported Drama during start-up	bb00bb	4	\N	\N	0	\N	\N
...
30	f	 the Artisan	v.has_badge(18)	Made a contribution to Drama text or art.	5555dd	3	\N	\N	0	\N	\N
...
31	f	 the Dumpster Arsonist	v.has_badge(20)	Joined Drama despite the flood of users crashing the site	885588	4	\N	\N	0	\N	\N
...
73	f	, Diamond Recruiter	v.referral_count>=1000	Refer 1000 friends to join Drama	bb00bb	1	\N	\N	\N	\N	\N
1	f	, Bronze Recruiter	v.referral_count>=1	Refer 1 friend to join Drama.	bb00bb	1	\N	\N	0	\N	\N
2	f	, Silver Recruiter	v.referral_count>=10	Refer 10 friends to join Drama.	bb00bb	1	\N	\N	0	\N	\N
3	f	, Gold Recruiter	v.referral_count>=100	Refer 100 friends to join Drama.	bb00bb	1	\N	\N	0	\N	\N
\.
